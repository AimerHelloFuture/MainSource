...
class EverydayPeopleBasic:
    ...
    def get_new(self):
        ...
        try:
            ths_cursor.execute(ths_037_sql, (self.seq, self.people_num - self.seq))
        except Exception, e:
            logging.error(e)
        new_data = ths_cursor.fetchall()
    ...
    def work(self):
        ...
        select_sql2 = 'select * from people_basicinfo where name = %s and back_gro = %s'

        ths_037 = self.get_new()
        ...
        for i in range(0, len(ths_037)):
            ...
            if back_gro is None:
                ...
                datacenter_cursor.execute(select_sql2, (name, back_gro))
