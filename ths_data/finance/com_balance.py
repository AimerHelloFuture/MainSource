...
def insert_data(data):
    ...
    try:
        ...
        new_num += 1
        print new_num, data[3], com_uni_code, end_date, announcement_date
    except Exception, e:
        logging.error(e)
...
if __name__ == '__main__':
    ...
    获取同花顺013信息个数
    '''
    ths_029_sql0 = 'select count(1) from ths013'
    try:
    ...
    for i in range(0, len(date_list)):
        for j in range(0, len(con_list)):
            ...
            for k in range(0, len(ths_013_0)):
                ...
                try:
                    ths_cursor.execute(ths_013_sql1, (date_list[i], con_list[j], code0))
                except Exception, e:
                    logging.error(e)
